...
class Decoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.conv_transpose1 = nn.ConvTranspose2d(out_channels2, 8, kernel_size=kernel_size2, bias=bias)
        self.conv_transpose2 = nn.ConvTranspose2d(8, out_channels1, kernel_size=kernel_size1, bias=bias)
        self.conv1 = nn.Conv2d(out_channels1, 16, kernel_size1, bias=bias)
        self.conv_transpose3 = nn.ConvTranspose2d(16, in_channels1, kernel_size=kernel_size1, bias=bias)
        self.relu = nn.ReLU()
