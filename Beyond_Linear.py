...
class Encoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.lin2 = nn.Linear(1024,2048,bias=bias)
        self.lin3 = nn.Linear(2048,4096,bias=bias)
...
class Decoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.conv_transpose1 = nn.ConvTranspose2d(out_channels2, 4, kernel_size=kernel_size1, bias=bias)
        self.conv1 = nn.Conv2d(4, 8, kernel_size1, bias=bias)
        self.conv_transpose2 = nn.ConvTranspose2d(8, out_channels1, kernel_size=kernel_size1, bias=bias)
        self.conv2 = nn.Conv2d(out_channels1, 16, kernel_size2, bias=bias)
        self.conv_transpose3 = nn.ConvTranspose2d(16, in_channels1, kernel_size=kernel_size2, bias=bias)
